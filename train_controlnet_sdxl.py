...
def main(args):
    ...
    if torch.backends.mps.is_available() and args.mixed_precision == "bf16":
        # due to pytorch#99272, MPS does not yet support float32.
        raise ValueError(
            "Mixed precision training with float32 is not supported on MPS. Please use fp16 (recommended) or fp32 instead."
        )
